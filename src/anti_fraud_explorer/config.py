...
class Settings(BaseSettings):
    ...
    * 布尔字段可直接使用 1/0 / true/false / yes/no 等表示。
    ...
    dataset_path: Path = Field(
        default=Path("data/processed/case_items.json"), alias="DATASET_PATH"
    )
    ...
    ai_base_url: str = Field(
        default="https://api.deepseek.com", alias="AI_BASE_URL"
    )
    ...
    volc_tts_max_chunk_bytes: int = Field(
        default=900, alias="VOLC_TTS_MAX_CHUNK_BYTES"
    )
